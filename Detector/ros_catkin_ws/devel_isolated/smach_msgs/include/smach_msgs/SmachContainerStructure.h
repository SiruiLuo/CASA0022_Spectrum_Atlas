...
struct Printer< ::smach_msgs::SmachContainerStructure_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::smach_msgs::SmachContainerStructure_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.internal_outcomes.size(); ++i)
    {
      ...
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.internal_outcomes[i]);
    }
    s << indent << "outcomes_from[]" << std::endl;
    for (size_t i = 0; i < v.outcomes_from.size(); ++i)
    {
      s << indent << "  outcomes_from[" << i << "]: ";
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.outcomes_from[i]);
    }
    s << indent << "outcomes_to[]" << std::endl;
    for (size_t i = 0; i < v.outcomes_to.size(); ++i)
    {
      s << indent << "  outcomes_to[" << i << "]: ";
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.outcomes_to[i]);
    }
    s << indent << "container_outcomes[]" << std::endl;
    for (size_t i = 0; i < v.container_outcomes.size(); ++i)
    {
      s << indent << "  container_outcomes[" << i << "]: ";
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.container_outcomes[i]);
    }
  }
};
